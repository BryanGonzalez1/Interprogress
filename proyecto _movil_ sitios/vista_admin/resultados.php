            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/vista_admin/detalle.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>&componente=<?php echo $fila["Componentes"]; ?>&dependencia=<?php echo $filatil[0]; ?>">
