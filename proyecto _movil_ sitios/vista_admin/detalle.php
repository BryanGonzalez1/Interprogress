...
<body>
    ...
    <div class="contenedor_data">
        ...
        <a href="/vista_admin/resultados.php?dependencia=<?php echo $_GET["dependencia"]; ?>&correo=<?php echo $_GET["correo"]; ?>&fecha=<?php echo $_GET["fecha"]; ?>"><input class="regresar" type="submit" value="Regresar"  name="btnAdd" style="width: 25%;"></input></a> <br>
        <?php if(isset($_GET['grafico'])){ ?>
            <a href="/vista_admin/detalle.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>&componente=<?php echo $_GET['componente']; ?>&dependencia=<?php echo $_GET['dependencia']; ?>"><input class="regresar" type="submit" value="Detallar"  name="btnAdd" style="width: 25%;"></input></a>
        <?php }else{ ?>
            <a href="/vista_admin/detalle.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>&componente=<?php echo $_GET['componente']; ?>&dependencia=<?php echo $_GET['dependencia']; ?>&grafico"><input class="regresar" type="submit" value="Resumir"  name="btnAdd" style="width: 25%;"></input></a>
        <?php } ?>
