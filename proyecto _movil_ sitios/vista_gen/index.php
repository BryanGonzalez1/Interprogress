...
<body>
    ...
    if (!empty($_POST["btnAdd"])) {
        ...
        if ($respuesta === "exito") {
            header("location:/vista_gen/resultados.php?correo=" . $fila[0] . "&fecha=" . $_POST['fecha'] . "");
        } else {
            ...
            <div class="formulario">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <h2>Departamento</h2>
                        ...
                        ?>
                    <input style="width: 250px;" name="correo" class="contenedortext" type="text" value="<?php echo $fila[1]; ?>" readonly></input>
