...
<body>
    ...
    <div class="cab">
        ...
        <a href="/dependencia/resultado_componente.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>">
            <div id="opcion">Regresar</div>
        </a>
        <?php if(isset($_GET['grafico'])){ ?>
            <a href="/dependencia/result_eje.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>&componente=<?php echo $_GET['componente']; ?>">
                <div id="opcion">Informacion detallada</div>
            </a>
        <?php }else{ ?>
            <a href="/dependencia/result_eje.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>&componente=<?php echo $_GET['componente']; ?>&grafico">
    ...
    <div class="contenedor_data">
        ...
        <?php
            ...
            ?>
                    <div class="<?php echo tipo_notacomp($fila[2]); ?>">
                    <?php 
