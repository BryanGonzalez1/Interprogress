...
<body>
    ...
    <div class="cab">
        ...
        <a href="/director/resultado_componente.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>">
            <div id="opcion">Regresar</div>
        </a>
        <?php if(isset($_GET['grafico'])){ ?>
            <a href="/director/result_eje.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>&componente=<?php echo $_GET['componente']; ?>">
                <div id="opcion">Informacion detallada</div>
            </a>
        <?php }else{ ?>
            <a href="/director/result_eje.php?correo=<?php echo $_GET['correo']; ?>&fecha=<?php echo $_GET['fecha']; ?>&componente=<?php echo $_GET['componente']; ?>&grafico">
