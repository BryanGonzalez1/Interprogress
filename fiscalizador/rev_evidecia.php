...
<body>
    ...
    if (!empty($_POST["btnAdd"])) {
        ...
        if ($respuesta === "exito") {
            echo "<script>repuestaCorrecta('Se ha guardado su revision.')</script>";
        } else {
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="formulario">
                        <div style="text-align:end;"><a href="/fiscalizador/rev_eje.php?codigo=<?php echo $_GET["codigo"]; ?>&dependencia=<?php echo $_GET["dependencia"]; ?>&fecha=<?php echo $_GET["fecha"]; ?>&reponsable=<?php echo $_GET["reponsable"]; ?>&titulo=<?php echo $_GET["titulo"]; ?>" class="del-btn"><img src="/image/simbolo/eliminar.png" alt="eliminar" class="simbolo"></a></div>
                        <div>
                            <h2>Dependencia</h2>
                            ...
                            <textarea type="text" name="mejora" class="contenedorArea"><?php echo $departamento[2]; ?></textarea>
