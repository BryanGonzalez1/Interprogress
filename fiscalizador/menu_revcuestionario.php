...
<head>
    ...
    <title>Menu revision cuestionario</title>
</head>
<body>
    <?php 
    ...
    ?>
        ...
        <div id="contenedor" style="margin-top: 50px;">
            <a href="/fiscalizador/rev_eje.php?codigo=Ambiente&titulo=Ambiente de Control&reponsable=<?php echo $_GET["responsable"];?>&dependencia=<?php echo $_GET["dependencia"];?>&fecha=<?php echo $_GET["fecha"];?>">
                <div class="tarjetas">
            ...
            <a href="/fiscalizador/rev_eje.php?codigo=Riesgo&titulo=Valoracion del Riesgo&reponsable=<?php echo $_GET["responsable"];?>&dependencia=<?php echo $_GET["dependencia"];?>&fecha=<?php echo $_GET["fecha"];?>">
                <div class="tarjetas">
            ...
            <a href="/fiscalizador/rev_eje.php?codigo=Actividad&titulo=Actividades de Control&reponsable=<?php echo $_GET["responsable"];?>&dependencia=<?php echo $_GET["dependencia"];?>&fecha=<?php echo $_GET["fecha"];?>">
                <div class="tarjetas">
            ...
            <a href="/fiscalizador/rev_eje.php?codigo=Sistema&titulo=Sistema de Informacion&reponsable=<?php echo $_GET["responsable"];?>&dependencia=<?php echo $_GET["dependencia"];?>&fecha=<?php echo $_GET["fecha"];?>">
                <div class="tarjetas">
            ...
            <a href="/fiscalizador/rev_eje.php?codigo=Seguimiento&titulo=Seguimiento de Control Interno&reponsable=<?php echo $_GET["responsable"];?>&dependencia=<?php echo $_GET["dependencia"];?>&fecha=<?php echo $_GET["fecha"];?>">
                <div class="tarjetas">
