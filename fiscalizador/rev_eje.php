    ...
    ?>
        <div style="width: 100%;">
            ...
            <div class="" style="float: left; margin-left:70%;">
                <a href="/fiscalizador/menu_revcuestionario.php?dependencia=<?php echo $_GET["dependencia"]; ?>&responsable=<?php echo $_GET["reponsable"]; ?>&fecha=<?php echo $_GET["fecha"]; ?>"><input type="submit" class="button" value="salir"></a>
            </div>
        </div>
        ...
        <div class="contenedor_data">
            ...
            ?>
                <a href="/fiscalizador/rev_evidecia.php?codigo=<?php echo $_GET["codigo"]; ?>&dependencia=<?php echo $_GET["dependencia"];?>&eje=<?php echo $fila[0];?>&fecha=<?php echo $_GET["fecha"]; ?>&reponsable=<?php echo $_GET["reponsable"]; ?>&titulo=<?php echo $_GET["titulo"]; ?>">
