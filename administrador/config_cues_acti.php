...
<head>
    ...
    <title>Configuración de cuestionario activo</title>
</head>
<body>
    <?php
    ...
    <div class="titulo_confi">
        <h1>Configuración del correo de cuestionario activo</h1>
    </div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="formulario cambio_color">                
                    <div>
                        ...
                        active una fecha de evaluación, donde
                        este sera enviado a todas las dependencias
                        registradas, indicando que el cuestionario
                        esta disponible para sus respuestas.
                    </div>
                </div>
            </form>
        </div>
