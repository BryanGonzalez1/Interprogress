...
<head>
    ...
    <title>Configuración de dependencia</title>
</head>
<body>
    <?php
    ...
    <div class="titulo_confi">
        <h1>Configuración del correo de dependencia</h1>
    </div>
        ...
        <div class="contenedor_form">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="formulario cambio_color">                
                    <div>
                        Este correo se utilizará cuando
                        el encargado de la dependencia haya 
                        finalizado el cuestionario, tocará
                        el botón para enviar formulario y
                        seguidamente, le llegará un correo
                        al fiscalizador responsable de 
                        esta dependencia indicando su
                        finalización.
                    </div>
                </div>
            </form>
                            ...
                            <div>
                                ...
                                <div>
                                    <div style="border: <?php echo $dat[4]?> 10px double; background-color:<?php echo $dat[3]; ?>;text-align: center;justify-content: center;">
                                        ...
                                        <br>
                                        <b style="font-size: xx-large;color: <?php echo $dat[6] ?>;">Contabilidad</b>
                                        <br>
                                        <br>
                                    </div>                                   
                                </div>
