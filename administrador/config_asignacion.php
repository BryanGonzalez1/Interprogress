...
<head>
    ...
    <title>Configuración de asignacion de roles</title>
</head>
<body>
    <?php
    ...
    <div class="titulo_confi">
        <h1>Configuración del correo de asignacion de roles</h1>
    </div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="formulario cambio_color">                
                    <div>
                        ...
                        le asigne un rol a un empleado.
                    </div>
                </div>
            </form>
        </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <div style="border: <?php echo $dat[4]?> 10px double; background-color:<?php echo $dat[3]; ?>;text-align: center;justify-content: center;">
                                        ...
                                        <br>
                                        <b style="font-size: xx-large;color: <?php echo $dat[6] ?>;">Administrador</b>
                                        <br>
                                        <br>
                                    </div>                                   
                                </div>
